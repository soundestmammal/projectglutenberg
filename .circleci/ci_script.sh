...
aws elasticbeanstalk create-application-version --application-name "oasis" --version-label v$CIRCLE_BUILD_NUM --description="New Version number $CIRCLE_BUILD_NUM" --source-bundle S3Bucket="elasticbeanstalk-us-east-2-670541471230.s3.us-east-2.amazonaws.com/oasis/",S3Key="app_v_$CIRCLE_BUILD_NUM.zip" --auto-create-application --region="us-east-2"
