...
let rest = {
    ...
    location: ['1194 Wantagh Ave', 'Wantagh, NY 11793'],
    image:
        'https://s3-media2.fl.yelpcdn.com/bphoto/k2Vh4K7j3tP2vcFa_yhYMA/o.jpg',
    price: '$',
    phone: '+15166796958',
    categories: [
        {
...
describe('Testing the UI of the Card component', () => {
    it('renders the card component', () => {
        const wrapper = mount(
            <Router>
                <Card rest={rest} address={rest.location} />
            </Router>
        );
    ...
    it('renders the correct restaurant name', () => {
        ...
        expect(wrapper.find('.restaurant-title').at(0).render().text()).toEqual(
            rest.name
        );
    });
    ...
    it('renders the correct restaurant number', () => {
        const wrapper = mount(
            <Router>
                <Card rest={rest} address={rest.location} index={1} />
            </Router>
        );
        expect(wrapper.find('.restaurant-title').at(1).render().text()).toEqual(
            '1'
        );
    });
    ...
    it('renders the correct address', () => {
        ...
        expect(wrapper.find('.card-address').length).toEqual(2);
    });
